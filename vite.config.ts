  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: '/lotopotes/',
        icons: [
          { src: '/lotopotes/icon-192.png', sizes: '192x192', type: 'image/png' },
          { src: '/lotopotes/icon-512.png', sizes: '512x512', type: 'image/png' },
          { src: '/lotopotes/icon-512.png', sizes: '512x512', type: 'image/png', purpose: 'maskable' },
        ],
